package Shipment::GSO::WSDL::Types::GetShippingActivityResult;
use strict;
use warnings;
...
Shipment::GSO::WSDL::Types::GetShippingActivityResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
GetShippingActivityResult from the namespace http://gso.com/GsoShipWS.
