package Shipment::GSO::WSDL::Types::TrackPickupResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'StatusReason' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
    },
    {
...
Shipment::GSO::WSDL::Types::TrackPickupResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TrackPickupResult from the namespace http://gso.com/GsoShipWS.
