package Shipment::GSO::WSDL::Types::SubmitShipmentInfo;
use strict;
use warnings;
...
Shipment::GSO::WSDL::Types::SubmitShipmentInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SubmitShipmentInfo from the namespace http://gso.com/GsoShipWS.
