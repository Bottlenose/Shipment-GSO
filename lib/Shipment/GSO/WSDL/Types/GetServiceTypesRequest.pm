package Shipment::GSO::WSDL::Types::GetServiceTypesRequest;
use strict;
use warnings;
...
Shipment::GSO::WSDL::Types::GetServiceTypesRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
GetServiceTypesRequest from the namespace http://gso.com/GsoShipWS.
